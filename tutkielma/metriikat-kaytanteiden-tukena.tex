...
\begin{enumerate}
    ...
    Muutokset näihin komponentteihin yleensä leviävät komponenttien riippuvuuksiin~\cite{ZN08}.
...
keskittyä vain lähimpiin syntaksivirheisiin. Yleisimmät mutaatio-operaattorit muuttavat, lisäävät sekä poistavat 
muuttujia ja ehtolauseita. Näitä ovat esimerkiksi \emph{ja} -operaattoreiden muuttaminen \emph{tai} -operaatioiksi.
...
kehittäjistä jotka ovat kokeilleet ketterää kehitystä haluavat jatkaa sen käyttämistä.
